		...
		<form method="post" enctype="multipart/form-data" id="update_service" action="{{route('companies.store')}}">
			...
			<div class="card mb-4 shadow-sm" style="border-radius: 12px; overflow: hidden; border: 1px solid #007bff;">
				<div class="card-header text-white py-3" style="background: linear-gradient(135deg, #0056b3, #007bff);">
					...
					<small class="text-white-50 font-weight-normal d-block">Specify pharmaceutical company name and corporate details below.</small>
				</div>
			...
			<div class="card mb-4 shadow-sm" style="border-radius: 12px; border: 1px solid #e3e8ee;">
				<div class="card-body p-3 d-flex justify-content-between align-items-center">
					...
					<button class="btn btn-success btn-lg rounded-pill px-5 shadow-sm" type="submit" name="form_submit" value="submit"><i class="fas fa-check-circle mr-1"></i> Submit Company</button>
				</div>
			</div>
		</form>
	</div>			
