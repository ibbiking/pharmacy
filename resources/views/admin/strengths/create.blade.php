...
@push('page-header')
<div class="col-sm-12">
    <h3 class="page-title">Add Strength</h3>
    <ul class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
        <li class="breadcrumb-item active">Add Strength</li>
    </ul>
</div>
@endpush
        ...
        <form method="POST" action="{{route('strengths.store')}}">
            ...
            <div class="card mb-4 shadow-sm" style="border-radius: 12px; overflow: hidden; border: 1px solid #007bff;">
                <div class="card-header text-white py-3" style="background: linear-gradient(135deg, #0056b3, #007bff);">
                    ...
                    <small class="text-white-50 font-weight-normal d-block">Specify dosage unit strengths (e.g. 500mg, 10ml, 250mcg, 1000IU).</small>
                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-0">
                                ...
                                <div class="custom-autocomplete-wrapper position-relative">
                                    <input class="form-control" type="text" name="name" id="strength_name_input" autocomplete="off" placeholder="Search or type strength name..." required value="{{old('name')}}">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group mb-0">
                                ...
                                <textarea class="form-control" name="description" rows="4" style="resize: vertical;" placeholder="Enter description...">{{old('description')}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card mb-4 shadow-sm" style="border-radius: 12px; border: 1px solid #e3e8ee;">
                <div class="card-body p-3 d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-success btn-lg rounded-pill px-5 shadow-sm" type="submit"><i class="fas fa-check-circle mr-1"></i> Submit Strength</button>
                </div>
            </div>
        </form>
    </div>
