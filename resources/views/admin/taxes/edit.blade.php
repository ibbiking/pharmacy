        ...
        <form method="POST" action="{{ route('taxes.update', $tax->id) }}">
            ...
            <div class="card mb-4 shadow-sm" style="border-radius: 12px; overflow: hidden; border: 1px solid #007bff;">
                <div class="card-header text-white py-3" style="background: linear-gradient(135deg, #0056b3, #007bff);">
                    ...
                    <small class="text-white-50 font-weight-normal d-block">Update purchase and sale tax percentages applied on invoices.</small>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                ...
                                <div class="custom-autocomplete-wrapper position-relative">
                                    <input class="form-control" type="text" name="name" id="tax_name_input" autocomplete="off" placeholder="Search or type tax name..." required value="{{ old('name', $tax->name) }}">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-0">
                                ...
                                <input class="form-control" type="number" step="0.01" min="0" name="rate" placeholder="e.g. 18.00" value="{{ old('rate', $tax->rate) }}" required>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card mb-4 shadow-sm" style="border-radius: 12px; border: 1px solid #e3e8ee;">
                <div class="card-body p-3 d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-primary btn-lg rounded-pill px-5 shadow-sm" type="submit"><i class="fas fa-sync-alt mr-1"></i> Update Tax</button>
                </div>
            </div>
        </form>
    </div>
