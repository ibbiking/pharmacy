...
@push('page-header')
<div class="col-sm-12">
    <h3 class="page-title">Edit Generic Product</h3>
    <ul class="breadcrumb">
        ...
        <div class="card">
            <div class="card-body custom-edit-service">
                ...
                <form method="post" enctype="multipart/form-data" id="update_service"
                    action="{{route('generic_products.update', $product->id )}}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                @php
                                    $oldCompany = old('company_id', $product->generic_company_id);
                                @endphp
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                @php
                                    $oldFarmulas = old('farmula_id', $product->farmula_id ? explode(',', $product->farmula_id) : []);
                                @endphp
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                @php
                                    $oldProductType = old('product_type_id', $product->generic_product_type_id);
                                @endphp
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                @php
                                    $oldStrengths = old('strength_id', $product->strength_id ? explode(',', $product->strength_id) : []);
                                @endphp
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="rack" class="form-control" placeholder="Enter Rack/Location" value="{{ old('rack', $product->rack) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>Barcode</label>
                                <input type="text" name="barcode" class="form-control" placeholder="Enter Barcode" value="{{ old('barcode', $product->barcode) }}">
                            </div>
                        </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="discount_percent" class="form-control"
                                        placeholder="0.00" value="{{ old('discount_percent', $product->discount_percent) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-check" style="margin-top: 32px;">
                                    <input type="checkbox" class="form-check-input" name="lock_max_discount" value="1"
                                        id="lockMaxDiscount" {{ old('lock_max_discount', $product->lock_max_discount) ? 'checked' : '' }}>
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control service-desc" name="description" rows="5" style="resize: vertical;">{{old('description', $product->description)}}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-right">
                                <button class="btn btn-primary submit-btn" type="submit" name="form_submit" value="update">Update Product</button>
                            </div>
                        </div>
                </form>
                <!-- /Add Product -->
