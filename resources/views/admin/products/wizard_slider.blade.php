    ...
    <div class="row m-0">
        ...
        <div class="col-md-9 p-4">
            ...
            <div class="tab-content" id="wizard-tabContent">
                ...
                <div class="tab-pane fade {{ $showStep1 ? 'show active' : '' }}" id="tab-categories" role="tabpanel" aria-labelledby="tab-categories-link">
                    ...
                    @if($isSinglePackaging)
                        <div class="alert alert-warning shadow-sm border-left-warning">
                            <h5 class="mb-1"><i class="fas fa-lock mr-2"></i> Single Packaging Locked</h5>
                ...
                <!-- STEP 2: PARAMETERS -->
                <div class="tab-pane fade {{ $showStep2 ? 'show active' : '' }}" id="tab-parameters" role="tabpanel" aria-labelledby="tab-parameters-link">
