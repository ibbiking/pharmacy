        ...
        <form method="POST" action="{{route('product-types.store')}}">
            ...
            <div class="card mb-4 shadow-sm" style="border-radius: 12px; overflow: hidden; border: 1px solid #007bff;">
                <div class="card-header text-white py-3" style="background: linear-gradient(135deg, #0056b3, #007bff);">
                    ...
                    <small class="text-white-50 font-weight-normal d-block">Categorize product forms (Tablet, Syrup, Injection, Ointment, etc.).</small>
                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-0">
                                ...
                                <div class="custom-autocomplete-wrapper position-relative">
                                    <input class="form-control" type="text" name="name" id="product_type_name_input" autocomplete="off" placeholder="Search or type product type name..." required value="{{old('name')}}">
            ...
            <div class="card mb-4 shadow-sm" style="border-radius: 12px; border: 1px solid #e3e8ee;">
                <div class="card-body p-3 d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-success btn-lg rounded-pill px-5 shadow-sm" type="submit"><i class="fas fa-check-circle mr-1"></i> Submit Product Type</button>
                </div>
            </div>
        </form>
    </div>
